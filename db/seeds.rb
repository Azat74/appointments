...
Customer.create(first_name: "Marge", last_name: "Simpson", email: "marge@evergreenterrace.com", phone: 13338594356)
Customer.create(first_name: "Bart", last_name: "Simpson", email: "elbarto@caramba.com", phone: 13338537691)
Customer.create(first_name: "Homer", last_name: "Simpson", email: "homer@doeh.com", phone: 13338926094)
